...
#define MAVLINK_MSG_ID_ELETRONIC_PROPULSION_LEN 14
#define MAVLINK_MSG_ID_ELETRONIC_PROPULSION_MIN_LEN 14
#define MAVLINK_MSG_ID_11_LEN 14
#define MAVLINK_MSG_ID_11_MIN_LEN 14

#define MAVLINK_MSG_ID_ELETRONIC_PROPULSION_CRC 136
#define MAVLINK_MSG_ID_11_CRC 136
...
static inline uint16_t mavlink_msg_eletronic_propulsion_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint16_t backup_potentiometer, uint16_t helm_potentiometer, uint16_t throttle_left_potentiometer, uint16_t throttle_right_potentiometer, uint32_t timestamp_seconds, uint16_t timestamp_milliseconds)
{
...
static inline void mavlink_msg_eletronic_propulsion_send(mavlink_channel_t chan, uint16_t backup_potentiometer, uint16_t helm_potentiometer, uint16_t throttle_left_potentiometer, uint16_t throttle_right_potentiometer, uint32_t timestamp_seconds, uint16_t timestamp_milliseconds)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ELETRONIC_PROPULSION_LEN];
    _mav_put_uint32_t(buf, 0, timestamp_seconds);
 ...
 */
static inline void mavlink_msg_eletronic_propulsion_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t backup_potentiometer, uint16_t helm_potentiometer, uint16_t throttle_left_potentiometer, uint16_t throttle_right_potentiometer, uint32_t timestamp_seconds, uint16_t timestamp_milliseconds)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS

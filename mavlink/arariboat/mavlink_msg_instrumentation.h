...
typedef struct __mavlink_instrumentation_t {
 float battery_voltage; /*< [V] Voltage sensor connected to A0 pin of ADS1115.*/
 float motor_current; /*< [A] Current sensor connected to A1 pin of ADS1115*/
 float battery_current; /*< [A] Current sensor connected to A2 pin of ADS1115.*/
 float mppt_current; /*< [A] Current sensor connected to A3 pin of ADS1115.*/
...
#define MAVLINK_MSG_ID_INSTRUMENTATION_CRC 250
#define MAVLINK_MSG_ID_171_CRC 250
...
#define MAVLINK_MESSAGE_INFO_INSTRUMENTATION { \
    ...
    {  { "battery_voltage", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_instrumentation_t, battery_voltage) }, \
         { "motor_current", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_instrumentation_t, motor_current) }, \
         { "battery_current", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_instrumentation_t, battery_current) }, \
 ...
 *
 * @param battery_voltage [V] Voltage sensor connected to A0 pin of ADS1115.
 * @param motor_current [A] Current sensor connected to A1 pin of ADS1115
 * @param battery_current [A] Current sensor connected to A2 pin of ADS1115.
 * @param mppt_current [A] Current sensor connected to A3 pin of ADS1115.
...
static inline uint16_t mavlink_msg_instrumentation_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float battery_voltage, float motor_current, float battery_current, float mppt_current)
{
...
{
    return mavlink_msg_instrumentation_pack(system_id, component_id, msg, instrumentation->battery_voltage, instrumentation->motor_current, instrumentation->battery_current, instrumentation->mppt_current);
}
...
{
    return mavlink_msg_instrumentation_pack_chan(system_id, component_id, chan, msg, instrumentation->battery_voltage, instrumentation->motor_current, instrumentation->battery_current, instrumentation->mppt_current);
}
...
static inline void mavlink_msg_instrumentation_send(mavlink_channel_t chan, float battery_voltage, float motor_current, float battery_current, float mppt_current)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_INSTRUMENTATION_LEN];
    _mav_put_float(buf, 0, battery_voltage);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_instrumentation_send(chan, instrumentation->battery_voltage, instrumentation->motor_current, instrumentation->battery_current, instrumentation->mppt_current);
#else
 ...
 */
static inline void mavlink_msg_instrumentation_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float battery_voltage, float motor_current, float battery_current, float mppt_current)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return [V] Voltage sensor connected to A0 pin of ADS1115.
 */
...
/**
 * @brief Get field motor_current from instrumentation message
 *
 * @return [A] Current sensor connected to A1 pin of ADS1115
 */
static inline float mavlink_msg_instrumentation_get_motor_current(const mavlink_message_t* msg)
{
 ...
 *
 * @return [A] Current sensor connected to A2 pin of ADS1115.
 */
static inline float mavlink_msg_instrumentation_get_battery_current(const mavlink_message_t* msg)
{
 ...
 *
 * @return [A] Current sensor connected to A3 pin of ADS1115.
 */
...
static inline void mavlink_msg_instrumentation_decode(const mavlink_message_t* msg, mavlink_instrumentation_t* instrumentation)
{
    ...
    instrumentation->motor_current = mavlink_msg_instrumentation_get_motor_current(msg);

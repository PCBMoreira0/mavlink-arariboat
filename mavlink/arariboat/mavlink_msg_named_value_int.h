...
#define MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN 24
#define MAVLINK_MSG_ID_NAMED_VALUE_INT_MIN_LEN 24
#define MAVLINK_MSG_ID_252_LEN 24
#define MAVLINK_MSG_ID_252_MIN_LEN 24

#define MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC 106
#define MAVLINK_MSG_ID_252_CRC 106
...
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_named_value_int_t, time_boot_ms) }, \
         { "name", NULL, MAVLINK_TYPE_CHAR, 10, 14, offsetof(mavlink_named_value_int_t, name) }, \
         { "value", NULL, MAVLINK_TYPE_INT32_T, 0, 4, offsetof(mavlink_named_value_int_t, value) }, \
         { "timestamp_seconds", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_named_value_int_t, timestamp_seconds) }, \
         { "timestamp_milliseconds", NULL, MAVLINK_TYPE_UINT16_T, 0, 12, offsetof(mavlink_named_value_int_t, timestamp_milliseconds) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT { \
...
static inline uint16_t mavlink_msg_named_value_int_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, const char *name, int32_t value, uint32_t timestamp_seconds, uint16_t timestamp_milliseconds)
{
...
{
    return mavlink_msg_named_value_int_pack(system_id, component_id, msg, named_value_int->time_boot_ms, named_value_int->name, named_value_int->value, named_value_int->timestamp_seconds, named_value_int->timestamp_milliseconds);
}
...
{
    return mavlink_msg_named_value_int_pack_chan(system_id, component_id, chan, msg, named_value_int->time_boot_ms, named_value_int->name, named_value_int->value, named_value_int->timestamp_seconds, named_value_int->timestamp_milliseconds);
}

/**
 * @brief Encode a named_value_int struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
...
{
    return mavlink_msg_named_value_int_pack_status(system_id, component_id, _status, msg,  named_value_int->time_boot_ms, named_value_int->name, named_value_int->value, named_value_int->timestamp_seconds, named_value_int->timestamp_milliseconds);
}
...
static inline void mavlink_msg_named_value_int_send(mavlink_channel_t chan, uint32_t time_boot_ms, const char *name, int32_t value, uint32_t timestamp_seconds, uint16_t timestamp_milliseconds)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_named_value_int_send(chan, named_value_int->time_boot_ms, named_value_int->name, named_value_int->value, named_value_int->timestamp_seconds, named_value_int->timestamp_milliseconds);
#else
 ...
 */
static inline void mavlink_msg_named_value_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, const char *name, int32_t value, uint32_t timestamp_seconds, uint16_t timestamp_milliseconds)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field timestamp_seconds from named_value_int message
 *
 * @return  Seconds since Unix time
 */
static inline uint32_t mavlink_msg_named_value_int_get_timestamp_seconds(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  8);
}

/**
 * @brief Get field timestamp_milliseconds from named_value_int message
 *
 * @return  Milliseconds within Unix time
 */
static inline uint16_t mavlink_msg_named_value_int_get_timestamp_milliseconds(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_named_value_int_decode(const mavlink_message_t* msg, mavlink_named_value_int_t* named_value_int)
{
    ...
    named_value_int->timestamp_seconds = mavlink_msg_named_value_int_get_timestamp_seconds(msg);
    named_value_int->timestamp_milliseconds = mavlink_msg_named_value_int_get_timestamp_milliseconds(msg);

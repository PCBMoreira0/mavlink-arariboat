...
#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN 18
#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_MIN_LEN 18
#define MAVLINK_MSG_ID_20_LEN 18
#define MAVLINK_MSG_ID_20_MIN_LEN 18

#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_CRC 151
...
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ { \
    ...
    "PARAM_REQUEST_READ", \
    2, \
    {  { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 2, offsetof(mavlink_param_request_read_t, param_id) }, \
...
{
    return mavlink_msg_param_request_read_pack(system_id, component_id, msg, param_request_read->param_id, param_request_read->param_index);
}
...
{
    return mavlink_msg_param_request_read_pack_chan(system_id, component_id, chan, msg, param_request_read->param_id, param_request_read->param_index);
}
...
{
    return mavlink_msg_param_request_read_pack_status(system_id, component_id, _status, msg,  param_request_read->param_id, param_request_read->param_index);
}
...
static inline void mavlink_msg_param_request_read_send(mavlink_channel_t chan, const char *param_id, int16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN];
    _mav_put_int16_t(buf, 0, param_index);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_request_read_send(chan, param_request_read->param_id, param_request_read->param_index);
#else
 ...
 */
static inline void mavlink_msg_param_request_read_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *param_id, int16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS

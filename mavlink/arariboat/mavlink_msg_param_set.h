...
#define MAVLINK_MSG_ID_PARAM_SET_CRC 22
#define MAVLINK_MSG_ID_23_CRC 22
...
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
    ...
    "PARAM_SET", \
    3, \
    {  { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 4, offsetof(mavlink_param_set_t, param_id) }, \
         { "param_value", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_param_set_t, param_value) }, \
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_param_set_t, param_type) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
...
{
    return mavlink_msg_param_set_pack(system_id, component_id, msg, param_set->param_id, param_set->param_value, param_set->param_type);
}
...
{
    return mavlink_msg_param_set_pack_chan(system_id, component_id, chan, msg, param_set->param_id, param_set->param_value, param_set->param_type);
}
...
{
    return mavlink_msg_param_set_pack_status(system_id, component_id, _status, msg,  param_set->param_id, param_set->param_value, param_set->param_type);
}
...
static inline void mavlink_msg_param_set_send(mavlink_channel_t chan, const char *param_id, float param_value, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_SET_LEN];
    _mav_put_float(buf, 0, param_value);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_set_send(chan, param_set->param_id, param_set->param_value, param_set->param_type);
#else
 ...
 */
static inline void mavlink_msg_param_set_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *param_id, float param_value, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS

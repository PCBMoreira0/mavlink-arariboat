...
static void mavlink_test_control_system(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_control_system_t packet1, packet2;
        ...
        packet1.pump_mask = packet_in.pump_mask;
    ...
    mavlink_msg_control_system_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_system_pack(system_id, component_id, &msg , packet1.dac_output , packet1.potentiometer_signal , packet1.pump_mask );
    mavlink_msg_control_system_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_system_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.dac_output , packet1.potentiometer_signal , packet1.pump_mask );
    mavlink_msg_control_system_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_control_system_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_system_send(MAVLINK_COMM_1 , packet1.dac_output , packet1.potentiometer_signal , packet1.pump_mask );
    mavlink_msg_control_system_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_instrumentation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_instrumentation_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.current_zero = packet_in.current_zero;
        packet1.current_one = packet_in.current_one;
        packet1.current_two = packet_in.current_two;
    ...
    mavlink_msg_instrumentation_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_instrumentation_pack(system_id, component_id, &msg , packet1.current_zero , packet1.current_one , packet1.current_two , packet1.voltage_battery );
    mavlink_msg_instrumentation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_instrumentation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.current_zero , packet1.current_one , packet1.current_two , packet1.voltage_battery );
    mavlink_msg_instrumentation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_instrumentation_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_instrumentation_send(MAVLINK_COMM_1 , packet1.current_zero , packet1.current_one , packet1.current_two , packet1.voltage_battery );
    mavlink_msg_instrumentation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_temperatures(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_temperatures_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_temperatures_pack(system_id, component_id, &msg , packet1.temperature_motor , packet1.temperature_mppt );
    mavlink_msg_temperatures_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_temperatures_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.temperature_motor , packet1.temperature_mppt );
    mavlink_msg_temperatures_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_temperatures_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_temperatures_send(MAVLINK_COMM_1 , packet1.temperature_motor , packet1.temperature_mppt );
    mavlink_msg_temperatures_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_gps_info_pos(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GPS_INFO_POS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_gps_info_pos_t packet_in = {
        17.0,45.0
    };
    mavlink_gps_info_pos_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.latitude = packet_in.latitude;
        packet1.longitude = packet_in.longitude;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GPS_INFO_POS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GPS_INFO_POS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_info_pos_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_gps_info_pos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_info_pos_pack(system_id, component_id, &msg , packet1.latitude , packet1.longitude );
    mavlink_msg_gps_info_pos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_info_pos_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.latitude , packet1.longitude );
    mavlink_msg_gps_info_pos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gps_info_pos_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gps_info_pos_send(MAVLINK_COMM_1 , packet1.latitude , packet1.longitude );
    mavlink_msg_gps_info_pos_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("GPS_INFO_POS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_GPS_INFO_POS) != NULL);
#endif
}
...
static void mavlink_test_arariboat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_gps_info_pos(system_id, component_id, last_msg);
}
